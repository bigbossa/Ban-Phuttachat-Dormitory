  ...
  const handleChangeRoomStatus = async (id: string, status: string) => {
    try {
      ...
      toast({
        ...
        style: {
          backgroundColor: status === "vacant" ? "#d1fae5" : 
                          status === "occupied" ? "#bfdbfe" : 
                          status === "maintenance" ? "#fef08a" : "#f3f4f6",
          color: status === "vacant" ? "#065f46" : 
                 status === "occupied" ? "#1e40af" : 
                 status === "maintenance" ? "#92400e" : "#374151",
        },
      });
    } catch (err) {
        ...
        <div className="flex gap-2">
          ...
          >
            <SelectTrigger className="w-[180px]">
              <SelectValue placeholder={t("status.text")} />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="vacant">{t("satatus.vacant")}</SelectItem>
              <SelectItem value="occupied">{t("satatus.occupied")}</SelectItem>
          ...
          >
            <SelectTrigger className="w-[180px]">
              <SelectValue placeholder={t("type.text")} />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="Standard Single">{t("Standard.Single")}</SelectItem>
              <SelectItem value="Standard Double">{t("Standard.Double")}</SelectItem>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        {(user?.role === "admin" || user?.role === "staff") && (
                          <>
                            ...
                            >
                              {t("Set.as")}{t("satatus.maintenance")}
                            </DropdownMenuItem>
                          </>
                        )}
                      </DropdownMenuContent>

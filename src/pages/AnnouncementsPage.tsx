...
export default function AnnouncementsPage() {
  ...
  const [announcements, setAnnouncements] = useState<Announcement[]>([
    {
      id: 1,
      title: t("announcements.sample1.title"),
      content: t("announcements.sample1.content"),
      date: "2025-05-20",
      important: true,
    },
    {
      id: 2,
      title: t("announcements.sample2.title"),
      content: t("announcements.sample2.content"),
      date: "2025-05-15",
      important: false,
    },
    {
      id: 3,
      title: t("announcements.sample3.title"),
      content: t("announcements.sample3.content"),
      date: "2025-05-25",
      important: true,
    },
  ]);
          ...
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent>
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="space-y-2">
                  <label htmlFor="date">{t("announcements.date")}</label>
                  <Input
                    id="date"
                    type="date"
            ...
            .map((announcement) => (
              <Card key={announcement.id}>
                <CardHeader>
                  ...
                  <CardDescription>
                    {format(parseISO(announcement.date), "MMMM d, yyyy")}
                  </CardDescription>
                </CardHeader>
                <CardContent>
